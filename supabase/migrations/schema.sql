...
CREATE TABLE Charging_Points (
                                 ...
                                 occupied BOOLEAN DEFAULT FALSE, -- true = occupato
...
-- 6. BOOKINGS (AGGIORNATA)
CREATE TABLE Bookings (
                          booking_id INT AUTO_INCREMENT PRIMARY KEY,
                          booking_datetime DATETIME NOT NULL, -- inizio
                          booking_end_datetime DATETIME NOT NULL, -- fine (default +1h)
                          user_id INT NOT NULL,
                          charging_point_id INT NOT NULL,
                          FOREIGN KEY (user_id) REFERENCES Users(user_id),
                          FOREIGN KEY (charging_point_id) REFERENCES Charging_Points(charging_point_id)
...
-- ⚠️ Inserimenti di esempio: utente, admin, operatori ecc.
...
-- ⚡ Stazioni + punti di ricarica (10 per stazione)
...
INSERT INTO Charging_Points (occupied, slots_num, station_id)
SELECT FALSE, 2, s.station_id
FROM Stations s,
